...
#     class Meta: 
#         constraints = [
#             models.UniqueConstraint(fields=['course_id', 'program_id', 'year', 'section'], name='unique_autumn1'),
#         ]

#     def __str__(self):
#         return str(self.course_id) + "    " + str(self.program_id.id) + "    " + str(self.year) + "    " + str(self.section) + "    " + str(self.faculty_sname);


# class Autumn_two(models.Model):
#     course_id = models.ForeignKey(Course, on_delete=models.CASCADE)
#     program_id = models.ForeignKey(Program, on_delete=models.CASCADE)
#     year = models.IntegerField()
#     section = models.CharField(max_length=1)
...
#     class Meta:
#         constraints = [
#             models.UniqueConstraint(fields=['course_id', 'program_id', 'year', 'section'], name='unique_autumn2'),
#         ]

#     def __str__(self):
#         return str(self.course_id) + "    " + str(self.program_id) + "    " + str(self.year) + "    " + str(self.section) + "    " + str(self.faculty_sname);


# class Winter_one(models.Model):
#     course_id = models.ForeignKey(Course, on_delete=models.CASCADE)
#     program_id = models.ForeignKey(Program, on_delete=models.CASCADE)
#     year = models.IntegerField()
#     section = models.CharField(max_length=1)
...
#     class Meta:
#         constraints = [
#             models.UniqueConstraint(fields=['course_id', 'program_id', 'year', 'section'], name='unique_winter1'),
#         ]
